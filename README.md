...
<b>Добавлена секция настроек</b><br>
...
<h2>Настройка</h2>
Для настройки вписываем свои значения после #define<br>
Например, для изменени ПЧ редуктора на 4 заменяем<br>
#define GearRatio 1 <br>
на<br>
#define GearRatio 4 <br>
<br>
Текст после войнойного слэша // будет проигнорирован программой
