...
> Переключателями **M2 - M4** выставить минимальную силу тока, при котором не будет пропуска шагов!

> Переключателем M6 устанавливается ток удержания вала, при **M6 - ON** он составляет 50% от тока вращения.
