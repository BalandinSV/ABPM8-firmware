...
- Зажать кнопку BREAK и подать питание<br>
- Дождаться пока светодиод на плате начнет мигать. Одна выспышка сигнализирует о <br>
готовности к записи кода первой кнопки. Нажать кнопку на пульте, отвечающий за поворот<br>
против часовой стрелки<br>
- Когда светодиод начнет мигать по два раза, нажать вторую кнопку пульта<br>
- Три вспышки светодиода сообщают о готовности записи кода команды "сканирование". Нажать<br>
обе кнопки на пульте одновременно.<br>
- Пульт готов к работе
