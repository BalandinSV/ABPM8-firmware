...
Для $\color{red}{\textsf{**записи**}}$  $\color{grey}{\textsf{// Игнорируется программой}}$ <b>записи</b> кодов пульта в память контроллера необходимо выполнить следующие действия:<br>
